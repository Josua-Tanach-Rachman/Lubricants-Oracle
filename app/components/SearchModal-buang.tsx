  ...
  >
    ...
    >
      ...
      <Box sx={{ display: "flex", gap: 3, flexWrap: "wrap" }}>
        {/* Left column */}
        <Box sx={{ width: { xs: "100%", md: "calc(50% - 12px)" }, minWidth: 280 }}>
              ...
              {filteredCategories.map((c) => (
                <React.Fragment key={c.title}>
                  <ListItemButton onClick={() => handleItemClick(c.title)}>
                    <ListItemText
                      primary={<Typography sx={{ color: "success.main" }}>{c.title}</Typography>}
                      secondary={<Typography variant="caption">{c.count} Product(s)</Typography>}
                    />
                  </ListItemButton>
              ...
              {filteredApplications.map((a) => (
                <React.Fragment key={a.title}>
                  <ListItemButton onClick={() => handleItemClick(a.title)}>
                    <ListItemText
                      primary={<Typography sx={{ color: "success.main" }}>{a.title}</Typography>}
                      secondary={<Typography variant="caption">{a.count} Product(s)</Typography>}
                    />
                  </ListItemButton>
                  <Divider component="li" />
                </React.Fragment>
