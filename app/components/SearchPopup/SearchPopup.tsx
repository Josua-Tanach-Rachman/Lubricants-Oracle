...
const subCategories: Record<string, CategoryItem[]> = {
  ...
  "Subsea Equipment": [{ name: "Subsea Equipment - General", count: 13 }],
  Transmissions: [{ name: "Transmissions - General", count: 3 }],
  "Turbine Oils": [{ name: "Turbine Oils - General", count: 4 }],
  Turbines: [{ name: "Turbines - General", count: 10 }],
  ...
  const BrowseMode = () => (
    <>
      ...
      <div className="sp-columns">
        ...
        >
          {openCategory && (
            <div className="sp-popover-header">{openCategory}</div>
          )}
